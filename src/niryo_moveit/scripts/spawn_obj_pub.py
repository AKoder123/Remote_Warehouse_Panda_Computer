...
if __name__ == "__main__":
  ...
  obj_A = Object(position=Vector3(0.47, 0, 0.165), x_bounds=(0.28, 0.51), y_bounds=(-0.239, 0.1), available=True)
  obj_B = Object(position=Vector3(0.37, -0.33, 0.165), x_bounds=(-2, 0.4702), y_bounds=(-2, -0.1), available=True)
  obj_C = Object(position=Vector3(0.42, 0.42, 0.165), x_bounds=(-2, 0.4757), y_bounds=(0.11, 2), available=True)
