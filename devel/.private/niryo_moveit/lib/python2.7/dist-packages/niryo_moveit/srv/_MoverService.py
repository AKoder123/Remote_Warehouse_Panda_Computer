...
class MoverServiceRequest(genpy.Message):
  _md5sum = "879b0307ccf4a7bd690b203b0664a310"
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_9d().pack(*self.joints_input.joints))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joints_input.joints = _get_struct_9d().unpack(str[start:end])
      _x = self
      start = end
      end += 224
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joints_input.joints = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=9)
      _x = self
      start = end
      end += 224
      (_x.joints_input.pick_pose.position.x, _x.joints_input.pick_pose.position.y, _x.joints_input.pick_pose.position.z, _x.joints_input.pick_pose.orientation.x, _x.joints_input.pick_pose.orientation.y, _x.joints_input.pick_pose.orientation.z, _x.joints_input.pick_pose.orientation.w, _x.joints_input.place_pose.position.x, _x.joints_input.place_pose.position.y, _x.joints_input.place_pose.position.z, _x.joints_input.place_pose.orientation.x, _x.joints_input.place_pose.orientation.y, _x.joints_input.place_pose.orientation.z, _x.joints_input.place_pose.orientation.w, _x.pick_pose.position.x, _x.pick_pose.position.y, _x.pick_pose.position.z, _x.pick_pose.orientation.x, _x.pick_pose.orientation.y, _x.pick_pose.orientation.z, _x.pick_pose.orientation.w, _x.place_pose.position.x, _x.place_pose.position.y, _x.place_pose.position.z, _x.place_pose.orientation.x, _x.place_pose.orientation.y, _x.place_pose.orientation.z, _x.place_pose.orientation.w,) = _get_struct_28d().unpack(str[start:end])
...
class MoverService(object):
  ...
  _md5sum = 'bd9b8037f9cd4f90705bed544fc4c913'
