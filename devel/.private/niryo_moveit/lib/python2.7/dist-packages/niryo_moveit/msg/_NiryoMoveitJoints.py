...
class NiryoMoveitJoints(genpy.Message):
  _md5sum = "c9d7e12bcbc4a843dba51b7ba48384e1"
  _type = "niryo_moveit/NiryoMoveitJoints"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float64[9] joints
...
"""
  ...
  _slot_types = ['float64[9]','geometry_msgs/Pose','geometry_msgs/Pose']
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_9d().pack(*self.joints))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joints = _get_struct_9d().unpack(str[start:end])
      _x = self
      start = end
      end += 112
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joints = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=9)
      _x = self
      start = end
      end += 112
      (_x.pick_pose.position.x, _x.pick_pose.position.y, _x.pick_pose.position.z, _x.pick_pose.orientation.x, _x.pick_pose.orientation.y, _x.pick_pose.orientation.z, _x.pick_pose.orientation.w, _x.place_pose.position.x, _x.place_pose.position.y, _x.place_pose.position.z, _x.place_pose.orientation.x, _x.place_pose.orientation.y, _x.place_pose.orientation.z, _x.place_pose.orientation.w,) = _get_struct_14d().unpack(str[start:end])
