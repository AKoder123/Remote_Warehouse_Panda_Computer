...
class NiryoMoveitJoints {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('joints')) {
        ...
        this.joints = new Array(9).fill(0);
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.joints.length !== 9) {
      throw new Error('Unable to serialize array field joints - length must be 9')
    }
    // Serialize message field [joints]
    bufferOffset = _arraySerializer.float64(obj.joints, buffer, bufferOffset, 9);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.joints = _arrayDeserializer.float64(buffer, bufferOffset, 9)
  ...
  static md5sum() {
    ...
    return 'c9d7e12bcbc4a843dba51b7ba48384e1';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.joints !== undefined) {
      ...
      resolved.joints = new Array(9).fill(0)
    }
