...
(cl:defmethod cl:initialize-instance :after ((m <FingerPosMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FingerPosMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unity_robotics_demo_msgs-msg:<FingerPosMsg> is deprecated: use unity_robotics_demo_msgs-msg:FingerPosMsg instead.")))

(cl:ensure-generic-function 'pos_1-val :lambda-list '(m))
(cl:defmethod pos_1-val ((m <FingerPosMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:pos_1-val is deprecated.  Use unity_robotics_demo_msgs-msg:pos_1 instead.")
  (pos_1 m))

(cl:ensure-generic-function 'pos_2-val :lambda-list '(m))
(cl:defmethod pos_2-val ((m <FingerPosMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:pos_2-val is deprecated.  Use unity_robotics_demo_msgs-msg:pos_2 instead.")
  (pos_2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FingerPosMsg>)))
  ...
  "unity_robotics_demo_msgs/FingerPosMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FingerPosMsg)))
  "Returns string type for a message object of type 'FingerPosMsg"
  "unity_robotics_demo_msgs/FingerPosMsg")
